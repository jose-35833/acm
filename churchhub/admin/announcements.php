...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($announcement_id) {
        ...
        $conn->query("INSERT INTO admin_logs (admin_id, action, table_name, record_id, description, ip_address)
                      VALUES ($admin_id, 'Edit', 'announcements', $announcement_id, 'Edited announcement: $title', '{$_SERVER['REMOTE_ADDR']}')");
        ...
        $conn->query("INSERT INTO admin_logs (admin_id, action, table_name, record_id, description, ip_address)
                      VALUES ($admin_id, 'Add', 'announcements', $new_id, 'Added new announcement: $title', '{$_SERVER['REMOTE_ADDR']}')");
    }
...
if (isset($_GET['delete'])) {
    ...
    $admin_id = $_SESSION['admin_id'];
    $conn->query("INSERT INTO admin_logs (admin_id, action, table_name, record_id, description, ip_address)
                  VALUES ($admin_id, 'Delete', 'announcements', $delete_id, 'Deleted an announcement', '{$_SERVER['REMOTE_ADDR']}')");
