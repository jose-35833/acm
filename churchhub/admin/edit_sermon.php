...
if (!isset($_GET['id'])) {
    echo "<script>window.location='manage_sermons.php';</script>";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        ");
        echo "<script>alert('Sermon updated successfully!'); window.location='manage_sermons.php';</script>";
    } else {
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            ...
            <form method="POST">
                ...
                <a href="manage_sermons.php" class="btn btn-secondary px-4">Cancel</a>
            </form>
        </div>
    </div>
</div>
